organization    := "io.github.vaedama"
name            := "url-shrtnr"
...
git.remoteRepo := "git@github.com:vaedama/url-shrtnr.git"

micrositeGithubOwner := "vaedama"

micrositeGithubRepo := "url-shrtnr"

micrositeName := "URL shortener"

micrositeDescription := "A URL shortener using FP techniques in Scala"

micrositeBaseUrl := "url-shrtnr"
